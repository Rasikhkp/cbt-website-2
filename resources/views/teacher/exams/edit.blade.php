    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('teacher.exams.update', $exam) }}" id="examForm">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description"
                                            ...
                                            placeholder="Brief description of the exam content and purpose">{{ old('description', $exam->description) }}</textarea>
                            ...
                            @if($questions->count() > 0)
                                        ...
                                        @foreach($questions as $index => $question)
                                            ...
                                            <div data-tags="{{ implode(', ', $question->tags) }}" class="question-item border border-gray-200 rounded p-3">
                                                <div class="flex items-start space-x-3">
                                                    ...
                                                    <div class="question-marks-input {{ $isSelected ? '' : 'hidden' }}">
                                ...
                                <div class="mt-4 p-3 bg-blue-50 rounded">
                                    <div class="flex justify-between items-center text-sm">
                                        <span>Selected Questions: <span id="selectedCount">{{ count($selectedQuestionIds) }}</span></span>
                                        <span>Total Marks: <span id="totalMarks">{{ array_sum($selectedQuestionMarks) }}</span></span>
                                    </div>
                                </div>
                            @else
