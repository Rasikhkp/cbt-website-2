    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div class="flex gap-2 justify-between items-center">
                <a href="{{ route('teacher.grading.exam', $attempt->exam->id) }}" class="text-blue-600 hover:text-blue-800 mr-4">← Back to
                    Grading: {{ $attempt->exam->title }}</a>
                                    ...
                                    <div class="space-y-2">
                                        @foreach ($answer->question->options as $option)
                                            <div
                                                ...
                                                @endif
                                                @if ($answer->answer_text == $option->option_text)
                                                    <span
